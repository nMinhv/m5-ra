...
public class AdminController {
    ...
    public ResponseEntity<?> addProduct(@RequestBody ProductRequest product) throws NotFoundException {
    ...
    public ResponseEntity<?> editProduct(@PathVariable("productId") Long id,
                                         @RequestBody ProductRequest product) throws NotFoundException {
